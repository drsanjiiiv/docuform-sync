...
* **Auto-Sync Engine:** Keep options refreshed on a schedule (**1h / 6h / 12h / 24h**) or **on every form submit** — fully multi-form safe, with a single shared time-driven trigger.
